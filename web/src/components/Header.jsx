export default function Header({ dateNote, totalValid }) {
  return (
    <header data-r="header" style={{
      ...
      <div data-r="stat" style={{ textAlign: 'right', fontFamily: "'IBM Plex Mono',monospace", color: '#a8a298', fontSize: 12, lineHeight: 1.8, whiteSpace: 'nowrap' }}>
        <div>{dateNote}</div>
